...
class Repository:
    ...
    def __init__(self, directory,db_directory):
        ...
        self.student_grades_table_db(db_con)
    ...
    def student_grades_table_db(self, db_con):
        """Instructor table from database"""
    
        p = PrettyTable(
            field_names=[ 'Name','CWID', 'Course', 'Grade', 'Instructor'])
        
        q = """select s.Name,s.CWID,g.Grade,g.Course,a.Name from HW11_students as s join HW11_grades as g join HW11_instructors as a on s.CWID=g.Student_CWID ;"""
